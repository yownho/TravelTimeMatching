...
########## INPUT and OUTPUT ##########
# codedir <- "C:\\Research\\Scale_sub_aveVel_0422\\Analysis\\kgw_all\\3200_smva"

# folder of output for velocity on the plane from HRR model
# datadir <- "C:\\Research\\Scale_sub_aveVel_0422\\Data\\HRR_velpl\\3200_smva"
f_Vp <- 'Vp_sub.csv'

# fTrtMS <- "C:\\Research\\Scale_sub_aveVel_0422\\Data\\GIS\\TT_smva_match_0520\\3200\\Tt3200_1stMS.dbf"
# fTrtMM <- "C:\\Research\\Scale_sub_aveVel_0422\\Data\\GIS\\TT_smva_match_0520\\3200\\Tt3200_1stMM.dbf"
...
# OUtput
kalltxtname <- paste("KgwSeg_cdf_sub",".txt", sep="")
...
write.table(outKall_table, file = "KgwSeg_cdf_sub.csv",  sep=",", row.names = FALSE,col.names = FALSE )
